...
<body>
	<div class="container">
		...
		<br>
		<div class="row">
			<a href="../pdf/cliente.php" target="blank" class="btn btn-info">Reporte pdf</a>
		</div>
		<br>
				...
				<tbody>
					<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								echo "<td class='centrar'><a href='modificar.php?idcliente=$idcliente'><img class='icono' src='../icon/modificar2.png'></a></td>";
						 
								echo "<td class='centrar'><a class='delete' href='eliminar.php?idcliente=$idcliente'><img class='icono' 
